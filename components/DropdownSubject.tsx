...
import { ResponseCardProps } from './ResponseCard'

interface DropdownSubjectProps {
    subjects: string[]
    setSelected: React.Dispatch<SetStateAction<string>>
    selected: string
}

export function DropdownSubject({ subjects, setSelected, selected }: DropdownSubjectProps) {
